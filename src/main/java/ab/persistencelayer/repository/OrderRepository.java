...
import ab.persistencelayer.dto.OrderEmployeeNameDto;
...
public interface OrderRepository extends JpaRepository<Order, Long> {
    ...
    @Query("select new ab.persistencelayer.dto.OrderEmployeeNameDto(o.creationDate, o.creationDate, concat(o.employee.name,' ',o.employee.surname)) from orders o join o.employee where o.orderId<= :limit " )
